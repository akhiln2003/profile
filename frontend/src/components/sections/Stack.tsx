...
import { Layers, Database, Cpu, Globe2, Code2 } from "lucide-react";
    ...
    >
      ...
      >
        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-aurora-2/30 bg-aurora-2/10 backdrop-blur-md mb-6">
          ...
          <span className="text-xs font-bold tracking-[0.2em] uppercase text-aurora-2">
            Technical Arsenal
          </span>
        </div>
        <h2 className="text-5xl md:text-7xl font-black tracking-tighter uppercase mb-4 drop-shadow-lg text-white">
          The{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-aurora-1 to-white">
            Stack
          </span>
        </h2>
        <p className="text-white/50 max-w-2xl text-lg mt-4 font-medium">
          Tools and technologies I use to build robust, scalable, and premium
          web applications.
        </p>
      </motion.div>
        ...
        {bentoItems.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-br ${item.gradient} opacity-20 group-hover:opacity-100 transition-opacity duration-700`}
              />
              ...
              <div className="relative h-full w-full bg-black/80 backdrop-blur-3xl rounded-[2.3rem] p-6 md:p-8 flex flex-col justify-between border border-white/5 group-hover:border-white/10 transition-colors">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/50 text-sm md:text-base font-medium line-clamp-2">
                    {item.desc}
                  </p>
                </div>
